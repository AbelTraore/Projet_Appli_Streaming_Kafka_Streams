...
class JSONDeserializerCommandes extends Deserializer[Commande]{
  ...
  override def deserialize(topic: String, data: Array[Byte]): Commande = {
    ...
    try {
      ...
      val d = objetMapper.readValue(data, classOf[Commande])
      d
