...
object ReduceProcessorKTable extends App {
  ...
  props.put(StreamsConfig.APPLICATION_ID_CONFIG, "reduce-processor-katable")
  props.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092")


  val str : StreamsBuilder = new StreamsBuilder()
  val kstrFacture : KTable[String, Facture] = str.table[String, Facture]("factureBinJSO")
  ...
  val kCA = kstrFacture
    ...
    )(Materialized.as("ReduceStoreKTable")(String, Double))
